...
export class PatientDecisionController {
  private logger = new Logger('PatientDecisionController');
  constructor(
    private readonly patientDecisionsService: PatientDecisionService,
  ) {}
