...
export class CommitteeResultsController {
  private logger = new Logger('CommitteeResultsController');
  constructor(
    private readonly committeeResultsService: CommitteeResultsService,
  ) {}
