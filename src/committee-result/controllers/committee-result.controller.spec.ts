...
import { CommitteeResultController } from './committee-result.controller';
import { CommitteeResultService } from '../services/committee-result.service';

describe('CommitteeResultsController', () => {
  let controller: CommitteeResultController;
  ...
  beforeEach(async () => {
    ...
    controller = module.get<CommitteeResultController>(
      CommitteeResultController,
    );
